...
<body>
	<div align="center">
		<h2>VIEW PLANS</h2>
		<br> <font color="green">${succMsg}</font> <font color="red">${failMsg}</font><br>
		<br /> <a href="planReg">+Add Plan</a><br />
		<br />
					...
					<c:choose>
						<c:when test="${plan.planStatus == 'ACTIVE'}">
							<td><a href="/editPlan?planId=${plan.planId}">Edit</a>
								&nbsp;&nbsp; <a href="/deactivatePlan?planId=${plan.planId}"
								onclick="return deactivateConfirm()">DeActivate</a>
                             </td>
						</c:when>
						<c:otherwise>
							<td><a href="/editPlan?planId=${plan.planId}">Edit</a>
								&nbsp;&nbsp; <a href="/activePlan?planId=${plan.planId}"
